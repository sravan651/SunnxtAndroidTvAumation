...
public class Hooks {
	...
	public void beforeMobileMethod(Scenario scenario) {
		...
		LogUtil.infoLog(getClass(),
				"\n+----------------------------------------------------------------------------------------------------------------------------+");
		LogUtil.infoLog(getClass(), "Android TV Tests Started: " + scenario.getName());

		LogUtil.infoLog("Android TV Test Environment",
				"Android TV Test is executed in OS: " + GlobalUtil.getCommonSettings().getAndroidName());
	}
	...
	public void afterMobileMethod(Scenario scenario) {
		if (scenario.isFailed()) {
			try {
				...
				ExtTest.getTest().log(LogStatus.FAIL,HTMLReportUtil.failStringRedColor("Failed at point: " + pathForLogger));
			...
			LogUtil.infoLog("End of Android TV Test", "Android TV Test has ended closing Application: "
