...
@CucumberOptions(features = "classpath:features/Sunnxt.feature",glue="com.sunnxt.stepdefs.android", plugin = { "pretty",
		"html:target/cucumber-html-report", "json:target/cucumber.json", "rerun:target/rerun.txt"  }, tags = "@previllageduser")
